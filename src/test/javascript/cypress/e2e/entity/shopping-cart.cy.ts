...
describe('ShoppingCart e2e test', () => {
  ...
  const shoppingCartSample = { placedDate: '2024-06-04T15:29:18.595Z', status: 'PAID', totalPrice: 6775.74, paymentMethod: 'CREDIT_CARD' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        gender: 'FEMALE',
        phone: '316.335.7837 x2395',
        addressLine1: 'since delightfully worried',
        addressLine2: 'ATM personal',
        city: 'Jerrodfurt',
        country: 'Guadeloupe',
      },
    }).then(({ body }) => {
  ...
  describe('new ShoppingCart page', () => {
    ...
    it('should create an instance of ShoppingCart', () => {
      cy.get(`[data-cy="placedDate"]`).type('2024-06-04T02:33');
      cy.get(`[data-cy="placedDate"]`).blur();
      cy.get(`[data-cy="placedDate"]`).should('have.value', '2024-06-04T02:33');
